...
try:
    ...
    print("Failed to connect to Arduino UNO (Drill)")
...
try :
    ...
    print ("Failed to connect to Arduino MEGA (Light A)")
...
def neons_B_on():
    ...
    mega_light.digitalWrite(neon_B_1, 0)
    mega_light.digitalWrite(neon_B_2, 0)
    mega_light.digitalWrite(neon_B_3, 0)
    mega_light.digitalWrite(neon_B_4, 0)

def neons_B_off():
    print ("Neons B all OFF")
    mega_light.digitalWrite(neon_B_1, 1)
    mega_light.digitalWrite(neon_B_2, 1)
    mega_light.digitalWrite(neon_B_3, 1)
    mega_light.digitalWrite(neon_B_4, 1)

def neons_C_on():
    print ("Neon A all ON")
    mega_light.digitalWrite(neon_C_1, 0)
    mega_light.digitalWrite(neon_C_2, 0)
    mega_light.digitalWrite(neon_C_3, 0)
    mega_light.digitalWrite(neon_C_4, 0)

def neons_C_off():
    print ("Neon A all OFF")
    mega_light.digitalWrite(neon_C_1, 1)
    mega_light.digitalWrite(neon_C_2, 1)
    mega_light.digitalWrite(neon_C_3, 1)
    mega_light.digitalWrite(neon_C_4, 1)
...
def false_random_neon():
    ...
    for i in range (5):
#mega_light.digitalWrite(neon_A_2, (i + 1) % 2)
        mega_light.digitalWrite(neon_A_1, 1)
        sleep(0.08)
        mega_light.digitalWrite(neon_B_1, 1)
        sleep(0.05)
